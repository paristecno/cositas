...
import movil from "../../../img/banerCelu.png"
import pc from "../../../img/bannerPC.png"
...
<div className="block sm:hidden">
        <img src={movil} className="w-full mb-10" alt="Banner móvil" />
      </div>
            ...
            <article key={product.id} className="relative">
              ...
              <div className="mt-4 flex items-start justify-between">
                <div className="">
                  ...
                  <div className="mt-2 flex items-center">
                    {[...Array(product.ratings)].map((_, index) => (
                      <svg key={index} className="block h-3 w-3 align-middle text-pink-600 sm:h-4 sm:w-4" xmlns="http://www.w3.org/2000/svg" viewBox="0 0 20 20" fill="currentColor">
